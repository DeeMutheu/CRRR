                ...
                <div class="container fb">
                    ...
                    <div class="dashboard-area">
                        <div class="d-flex flex-row-reverse">
                            <button type="button" class="btn w-10 btn-primary mb-2 text-center" data-bs-toggle="modal" data-bs-target="#AddModal">Add Category</button>
                        </div>
                        <!-- Add Modal -->
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Register New Category Of Services</h5>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label class="text-center">Category name <span class="text-danger">*</span></label>
                                                    <input type="text" name="category_name" required class="form-control">
                                                    <input type="hidden" name="category_response_service_id" value="<?php echo $_SESSION['login_id']; ?>" required class="form-control">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="text-center">
                                                <button name="Add_Categories" class="btn btn-primary" type="submit">
                        ...
                        <div class="list item-list recent-jobs-list">
                            <?php
                            //Get Response Services Offered By This Service Provider
                            $services_sql = mysqli_query(
                                $mysqli,
                                "SELECT * FROM incident_categories  ic
                                INNER JOIN login l ON   ic.category_response_service_id= l.login_id"
                            );
                            ...
                            ?>
                                    <div class="card job-post filter">
                                        <div class="card-body">
                                            ...
                                            <div class="card-info">
                                                <h6 class="title"><?php echo $services['category_name']; ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                <div class="card job-post filter">
                                    <div class="card-body">
                                        <div class="card-info">
                                            <h6 class="title text-danger">No Incident Categories Available </h6>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
