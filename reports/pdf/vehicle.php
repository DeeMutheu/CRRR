                    ...
                    <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                        <thead>
                            <tr>
                                ...
                                <th style="width:100%">Owner names</th>
                                <th style="width:30%">Contacts</th>
                                <th style="width:50%">License No</th>
                                ...
                                if (mysqli_num_rows($pdf_sql) > 0) {
                                    while ($row = mysqli_fetch_array($pdf_sql)) {
                                        $html .=
                                            ...
                                            <tr>
                                                <td>' . $cnt . '</td>
                                                <td>' . $row['vehicle_owners_name'] . '</td>
                                                <td>' . $row['vehicle_owners_phone_number'] . '</td>
                                                <td>' . $row['vehicle_license_plate_number'] . '</td>
