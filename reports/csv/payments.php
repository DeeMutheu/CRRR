...
/* Excel Column Name */
$fields = array('#', 'Payment REF Code',  'Payment Method', 'Payment Amount', 'Payment Date');
...
$query = $mysqli->query("SELECT * FROM fine_payment");
$cnt = 1;
if ($query->num_rows > 0) {
    ...
    $excelData .= 'No Payment Records Available...' . "\n";
}
